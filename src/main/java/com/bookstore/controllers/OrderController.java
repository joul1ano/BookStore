...
public class OrderController {
    ...
    @Operation(
            ...
            description = "Returns a list of order summaries for the authenticated user. Access = [USER]"
    )
    ...
    @PreAuthorize("hasRole('USER')")
    @Operation(
            summary = "Get my order's details by id",
            description = "Returns an order's full details for the authenticated user. Access = [USER]"
    )
    ...
    @Operation(
            ...
            description = "Returns the created order for the authenticated user. Access = [USER]"
    )
    ...
    @Operation(
            ...
            description = "Returns full details of a user's order. Access = [ADMIN]"
    )
    ...
    @Operation(
            ...
            description = "Returns the order summary with the updated status. Access = [USER]"
    )
